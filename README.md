...
1. Ele lê o catálogo armazenado em `data/dataset.json`.
2. Instancia um objeto da classe `Graph`.
3. Adiciona cada obra como um `Node` (vértice) e mapeia as similaridades com seus respectivos pesos (penalidades conceituais).
...
1. O arquivo `static/script.js` faz uma requisição assíncrona ao servidor.
2. Ao receber a resposta, a função limpa o container HTML e reconstrói o grafo na tela dinamicamente.
3. Utilizando cálculos matemáticos, o JavaScript distribui radialmente as recomendações ao redor do nó de origem.

---

## 3. Como Executar a Aplicação Web

Para rodar o ecossistema completo e ver o grafo funcionando de forma gráfica, siga os passos abaixo no terminal:
